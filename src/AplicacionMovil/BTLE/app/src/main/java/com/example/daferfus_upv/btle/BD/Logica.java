...
public class Logica extends SQLiteOpenHelper {
    ...
    //                  <- Context
    //
    // Invocado desde: MantenimientoDeMedidasWorker
    // Función: Evita que corran a la vez varias instancias de la base de datos.
    // --------------------------------------------------------------
    public static synchronized Logica getInstance(Context ctx) {

        // Use the application context, which will ensure that you
        // don't accidentally leak an Activity's context.
        // See this article for more information: http://bit.ly/6LRzfx
        if (mInstance == null) {
            mInstance = new Logica(ctx.getApplicationContext());
        }
        return mInstance;
    }
    // ----------------------------------------------------------------------------------------
